_base_ = '../UltraSAM_full/UltraSAM_point_refine.py'
...
orig_val_evaluator['ann_file'] = '{}/{}'.format(data_root, test_ann_file)
val_evaluator = orig_val_evaluator

orig_test_evaluator = _base_.test_evaluator
orig_test_evaluator['ann_file'] = '{}/{}'.format(data_root, test_ann_file)
