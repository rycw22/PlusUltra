...
def parse_args():
    parser = argparse.ArgumentParser(
        description=f"Convert TG3K to frames & COCO style annotations")
    parser.add_argument(
        '--path',
        type=str,
        help='dataset path',
    ...
    parser.add_argument(
        ...
        default=f"/media/ameyer/Data4/ULTRASam/datasets/TG3K")
    parser.add_argument(
        '--save-viz',
        action='store_false',
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        img_dir = f"{temp_dir}/Thyroid Dataset/tg3k/thyroid-image/"
        mask_dir = f"{temp_dir}/Thyroid Dataset/tg3k/thyroid-mask/"
