...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        data_path = f"{temp_dir}/EchoNet-Dynamic"
        logging.info("Done")
        ...
        for video_name in segmentation_masks.keys():
            coco = CocoAnnotationObject(
                ...
                dataset_url="https://github.com/echonet/dynamic "
            )
            coco.set_categories([
